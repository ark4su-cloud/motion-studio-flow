...
const links = [
  { label: "Telegram: Contact @ArtioMotion", icon: Send, href: "#", highlight: true },
  { label: "NEW Fiverr", icon: Palette, href: "#" },
  { label: "Instagram", icon: Camera, href: "#" },
  { label: "WhatsApp", icon: MessageCircle, href: "#" },
  { label: "TikTok", icon: Music2, href: "#" },
  { label: "ArtioMotion YouTube", icon: Youtube, href: "#" },
  { label: "vimeo.com", icon: Play, href: "#" },
  { label: "www.linkedin.com", icon: Linkedin, href: "#" },
];
        ...
        <div className="flex flex-col gap-3">
          {links.map((link, i) => (
            <motion.a
              ...
              whileTap={{ scale: 0.98 }}
              className={`rounded-2xl glass-card group relative ${
                link.highlight ? "animated-stroke-slow" : "stroke-on-hover"
              }`}
            >
              <div className="relative flex items-center gap-4 px-5 py-4">
                <motion.div
                  className="w-10 h-10 rounded-full bg-secondary/60 flex items-center justify-center shrink-0 group-hover:bg-secondary transition-colors"
                  {...(link.highlight
                    ? {
